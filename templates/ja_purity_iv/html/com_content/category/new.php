...
<?php $blogMasonry = $this->params->get('show_layout') == 'layout_masonry' ? ' view-masonry' : '' ?>
<?php $blogLayout = $this->params->get('show_layout') ?>


<div class="com-content-category-blog blog<?php echo $this->pageclass_sfx; ?> <?php echo $blogLayout ?><?php echo $blogMasonry ?>" itemscope itemtype="https://schema.org/Blog">
  ...
  <?php if (!empty($this->intro_items)) : ?>
    ...
    <div class="com-content-category-blog__items blog-items <?php echo $blogClass; ?>">
      <div id="item-container" class="items-row cols-<?php echo (int) $this->columns; ?> row-cols-1 <?php echo $this->columns == 1 ? '' : 'row-cols-sm-2'; ?> row-cols-xl-<?php echo $this->columns; ?> row">
        <?php foreach ($this->intro_items as $key => &$item) : ?>
          <div class="item">
            <div class="item-inner<?php echo $item->state == 0 ? ' system-unpublished' : null ?>" itemprop="blogPost" itemscope itemtype="https://schema.org/BlogPosting">
              <?php
              $this->item = &$item;
              echo $this->loadTemplate('item');
              ?>
