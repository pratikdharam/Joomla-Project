...
<div class="<?php echo $moduleclass_sfx; ?>magz-layout highlight-lists row row-cols-1 row-cols-md-2">
          ...
          <div class="blog-item">
            <div class="row">
              ...
              ?>
                ...
                <a class="item-image col-12 col-md-4" href="<?php echo $item->link; ?>" title="<?php echo $item->title; ?>">
                  <img src="<?php echo htmlspecialchars($images->image_intro); ?>" alt="<?php echo $item->title; ?>" />
                </a>
              <?php } ?>
              <!-- // Item image -->

              <div class="item-contents col-12 col-md-8">
                <div class="item-meta">
                  <?php if ($item->displayCategoryTitle) : ?>
                    <span class="item-cat">
                      <?php echo $item->displayCategoryTitle; ?>
