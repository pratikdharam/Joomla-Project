...
<form action="<?php echo JRoute::_ ('index.php?option=com_virtuemart&view=cart'); ?>" method="post" class="inline">
	<div class="row vm-change-shopper-wrap">
		<div class="col-12 col-md-6">
			<input class="vm-user-search inputbox" type="text" name="usersearch" size="20" maxlength="50">
			<input class="btn btn-secondary" type="submit" name="searchShopper" title="<?php echo vmText::_('COM_VIRTUEMART_SEARCH'); ?>" value="<?php echo vmText::_('COM_VIRTUEMART_SEARCH'); ?>" class="button"  style="margin-left: 10px;"/>
		</div>
		<div class="col-12 col-md-6 d-flex align-item-center gap-3">
			<div>
			<?php
			...
			<input class="btn btn-primary" type="submit" name="changeShopper" title="<?php echo vmText::_('COM_VIRTUEMART_GO'); ?>" value="<?php echo vmText::_('COM_VIRTUEMART_GO'); ?>" class="button" />
